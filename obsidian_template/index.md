# Welcome to the Archivatorium Archive

## Project Overview
**archivatorium** is a specialized toolkit for cleaning, formatting, and validating OCR outputs processed by Large Language Models (LLMs) and Vision-Language Models (VLMs). This vault serves as a structured, searchable, and interlinked archive of processed historical documents.

- **GitHub Repository:** [honzas83/archivatorium](https://github.com/honzas83/archivatorium)
- **Toolkit Documentation:** [README.md](https://github.com/honzas83/archivatorium/blob/main/README.md)
...
archivatorium ocr ./raw_pdfs ./raw_markdown --model qwen3.5:9b

# 2. Clean up OCR formatting and wrap lines
archivatorium clean ./raw_markdown ./cleaned_markdown

# 3. Extract metadata and tags using Ollama
archivatorium metadata ./cleaned_markdown ./vault_output \
...
archivatorium interlink ./vault_output
```

---
*Generated by archivatorium — transforming historical OCR into structured knowledge.*
