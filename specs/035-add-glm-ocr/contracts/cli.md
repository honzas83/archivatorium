...
This changes only the model name and five explicit values. It does not enable thinking, add a system prompt, or add previous-page context.

## Compatibility contract

When `--mode` is omitted or set to `standard` and all five new inference options are omitted:
