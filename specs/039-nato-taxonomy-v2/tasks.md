...
- [X] T016 [US3] Serialize the classifier prompt payload as classification_policy plus topics without editorial root fields in archivatorium/services/tagging_service.py
...
- [X] T019 [US4] Execute fresh local v1 and v2 metadata runs against data/039-nato-taxonomy-v2/input/ and record command/outcome comparisons in data/039-nato-taxonomy-v2/reports/rerun-comparison.md
