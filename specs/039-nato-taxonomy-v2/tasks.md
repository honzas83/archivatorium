...
- [ ] T007 [US1] Align TopicResult, WindowTaggingResult, and AggregatedTaggingResult field descriptions with all-substantive-but-not-marginal selection and valid empty topic lists in archivatorium/models/metadata.py
...
- [ ] T011 [US2] Create the complete schema-v2 classification policy and 55-topic hierarchy with the reviewed definitions and counterexamples in topics/NATO_themes_v2.yaml without modifying topics/NATO_themes.yaml
